...
urls = {
    "AAPL": "https://raw.githubusercontent.com/Joshuadcooke/TermProjectData/main/AAPL_Post_Covid.csv",
    "JPM": "https://raw.githubusercontent.com/Joshuadcooke/TermProjectData/main/JPM_Post_Covid.csv",
    "TSLA": "https://raw.githubusercontent.com/Joshuadcooke/TermProjectData/main/TSLA_Post_Covid.csv",
    "XOM": "https://raw.githubusercontent.com/Joshuadcooke/TermProjectData/main/XOM_Post_Covid.csv",
    "META": "https://raw.githubusercontent.com/Joshuadcooke/TermProjectData/main/META_Post_Covid.csv",
    "S&P 500": "https://raw.githubusercontent.com/Joshuadcooke/TermProjectData/main/%5EGSPC_Post_Covid.csv"
}
...
# Calculate average monthly returns for each stock in the post-COVID period and convert to percentage
monthly_returns = daily_returns.resample('ME').apply(lambda x: (1 + x / 100).prod() - 1)
post_covid_avg_returns = monthly_returns[tickers].mean() * 100  

print("Average Monthly Returns Post-COVID (2022–2024):")
print(post_covid_avg_returns.apply(lambda x: f"{x:.2f}%"))  
...
portfolio_ending_cumulative_return = cumulative_portfolio_return.iloc[-1] * 100 
sp500_ending_cumulative_return = cumulative_sp500_return.iloc[-1] * 100  
...
fig1, ax1 = plt.subplots(figsize=(12, len(trade_log) * 0.4))  
ax1.axis('off')  
...
fig1.text(0.5, 0.74, "Monthly Trade Log (+1 = Buy and 0 = No Position)", ha='center', fontsize=12, weight='bold')
