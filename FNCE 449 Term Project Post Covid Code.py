...
post_covid_avg_returns = monthly_returns[tickers].mean() * 100  # Convert to percentage

print("Average Monthly Returns Post-COVID (2022–2024) as Percentages:")
print(post_covid_avg_returns.apply(lambda x: f"{x:.2f}%"))  # Display as percentage
...
fig1, ax1 = plt.subplots(figsize=(12, len(trade_log) * 0.4))  # Adjust height to be slightly smaller
