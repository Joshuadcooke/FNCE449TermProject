...
pre_covid_avg_returns = monthly_returns[tickers].mean() * 100  

print("Average Monthly Returns Pre-COVID (2016–2018):")
print(pre_covid_avg_returns.apply(lambda x: f"{x:.2f}%")) 
...
fig1, ax1 = plt.subplots(figsize=(12, len(trade_log) * 0.5))  
ax1.axis('off')
